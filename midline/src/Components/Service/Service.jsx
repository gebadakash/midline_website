...
import AboutBannerImage from "../../assets/images/bannew.jpg";
...
const Service = ({serviceItems}) => {
  ...
  const {ServiceTitle} = useGlobalContext();
    ...
    return (
        <div className='mt-5'>
            <div className="container-fluid py-5"  style={{backgroundImage: `url(${AboutBannerImage})`, backgroundSize: 'cover'}}>
